         ...
         <div className="myskills">
             <div className="cover row"><div className="col-sm-6 cover2"></div><div className="col-sm-6 cover2"></div></div> 
                ...
                <div data-aos="fade-up" className="display2">
                  <div  style={{textAlign:"center",width:"33vw"}}><img src="/assets/Angular.svg"></img><div class="label">Angular 10</div></div>
                  ...
                  <div  style={{textAlign:"center",width:"33vw"}}><img src="/assets/mongo.svg"></img><div class="label">MongoDB</div></div>
